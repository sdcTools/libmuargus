...
void SwigDirector_IProgressListener::UpdateProgress(int perc) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jperc = (jint) perc;
    jenv->CallStaticVoidMethod(Swig::jclass_MuArgusCtrlJNI, Swig::director_method_ids[0], swigjobj, jperc);
...
SWIGEXPORT jboolean JNICALL Java_muargus_extern_dataengine_MuArgusCtrlJNI_CMuArgCtrl_1MakeAnonFile(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jint jarg3, jintArray jarg4, jstring jarg5, jintArray jarg6) {
  jboolean jresult = 0 ;
  CMuArgCtrl *arg1 = (CMuArgCtrl *) 0 ;
  std::string arg2 ;
  long arg3 ;
  ...
  result = (bool)(arg1)->MakeAnonFile(arg2,arg3,arg4,arg5,arg6);
  jresult = (jboolean)result; 
  SWIG_JavaArrayArgoutLong(jenv, jarr4, (long *)arg4, jarg4); 
  {
    jint jvalue = (jint)temp6;
